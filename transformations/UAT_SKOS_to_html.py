...
filealpha.write('<form name="testing1">\n<input type="text" id="uat-autocomplete-single" name="uatterm1"> <INPUT TYPE="button" value="Search" onClick="parent.rightframe.location=\'http://wolba.ch/astrothesaurus/uat/termrecords/\' + uatterm1.value.split(\' \').join(\'+\') + \'.html\'">\n</form>\n')
